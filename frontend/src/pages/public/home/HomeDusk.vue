<template>
  <div class="yoga-container">
    ...
    <section class="dusk-hero">
      <div class="hero-eyebrow">Daily practice</div>
    ...
    <section v-if="dailyCard" class="q-mb-xl">
      <q-card>
        <q-card-section class="text-center">
          <div class="hero-eyebrow q-mb-sm">Today</div>
          <div v-if="dailyCard.phrase" class="text-h3 text-primary q-mb-xs">
            {{ dailyCard.phrase }}
          </div>
          <div class="text-h5 q-mb-md">{{ dailyCard.title }}</div>
          <p v-if="dailyCard.short_answer" class="hero-lede hero-lede--center q-mb-none">
            {{ dailyCard.short_answer }}
          </p>
          <p v-else class="hero-lede hero-lede--center q-mb-none">{{ dailyCard.definition }}</p>
        </q-card-section>
